...
export default function ServiceCategoryCard({ category, onClick }: ServiceCategoryCardProps) {
  ...
  const getIconColorClass = () => {
    switch (category.name) {
      ...
      case "Home Cleaning": return "text-purple-600";
  ...
  const getBgColorClass = () => {
    switch (category.name) {
      ...
      case "Home Cleaning": return "bg-purple-100 group-hover:bg-purple-200";
      case "Painting": return "bg-orange-100 group-hover:bg-orange-200";
      case "Carpentry": return "bg-red-100 group-hover:bg-red-200";
      case "Landscaping": return "bg-green-100 group-hover:bg-green-200";
  ...
  const getHoverColorClass = () => {
    switch (category.name) {
      ...
      case "Home Cleaning": return "group-hover:text-purple-700";
      case "Painting": return "group-hover:text-orange-700";
      case "Carpentry": return "group-hover:text-red-700";
      case "Landscaping": return "group-hover:text-green-700";
